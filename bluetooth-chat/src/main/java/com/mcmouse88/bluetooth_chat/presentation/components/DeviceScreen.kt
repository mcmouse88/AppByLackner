package com.mcmouse88.bluetooth_chat.presentation.components
...
import com.mcmouse88.bluetooth_chat.presentation.BluetoothUiState
    ...
    LazyColumn(
        ...
        items(pairedDevices) { device ->
            Text(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .clickable { onClick.invoke(device) }
                    .padding(16.dp)
            )
        }
